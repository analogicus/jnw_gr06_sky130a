...
C {devices/ipin.sym} 110 140 0 0 {name=p13 lab=IP}
C {devices/ipin.sym} 810 140 0 1 {name=p14 lab=IN}
C {devices/lab_pin.sym} 200 -160 0 0 {name=p8 sig_type=std_logic lab=OUT-}
